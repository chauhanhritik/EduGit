           ...
           <div className="nav">
            ...
            <div className="center">
                <ul className="topicon">
                    <li className="listitem">
                        <Link classname='link' style={{ textDecoration: 'none', color: 'inherit' }} to='/'>
                             Home 
                        </Link>
                    </li>
                    <li className="listitem">
            ...
            <div className="right">
                ...
                <img className="topimg" src="https://cdn.pixabay.com/photo/2016/02/16/21/07/books-1204029_960_720.jpg" alt="" srcset="" />
                   ...
                   <ul className="topicon">
                    <Link className='listitem' to='/login'  style={{ textDecoration: 'none', color: 'inherit' }}>Login </Link>
                    <Link className='listitem' to='/register'  style={{ textDecoration: 'none', color: 'inherit' }}> Register</Link>
                   </ul>
                )}
